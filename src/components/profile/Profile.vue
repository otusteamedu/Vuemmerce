<template>
  <div class="columns is-centered is-multiline">
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input
                ...
                v-model="email"
                :class="{'red-border': !isEmailCorrect}"
              />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <select v-model="address" :class="{'red-border': !isAddressCorrect}">
                <option
                  v-for="(address, index) in userInfo.addresses"
                  :value="index"
                  :selected="userInfo.mainAddress == index ? true : false"
                  :key="index"
                >{{address}}</option>
              </select>
            </td>
          ...
          <tr>
            ...
            <td>
              <input type="password" v-model="password" :class="{'red-border': !isPasswordCorrect}" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input
                ...
                :class="{'red-border': !isPasswordCorrect}"
              />
            </td>
          </tr>
          <tr>
    ...
    <div class="profile" v-else>{{ $t("profile.pleaseLogin") }}</div>
  </div>
</template>
...
export default {
  ...
  beforeMount: function() {
    this.address = this.userInfo.mainAddress;
  }
};
</script>
